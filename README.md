## CEG 4110 Group 11 Tank Project

### Project Details
- Requirements can be found in file labeled Requirements in the top level directory.
- Design is located within src files. Documentation for design can be generated by running "doxygen Doxyfile" while in the top level project directory. The main page of the documentation will display SoftwareDesignSpec.md which explains the software design. 
- Test results can be found in Test.md located in the top level directory.
